...
fig1 = plt.figure(figsize=(90*mm, 45*mm), facecolor='w')
...
plt.semilogy(depths, Ex_amp_empymod_qwe,':+',color='black', markersize=7, linewidth=1, label='previous_qwe')
plt.legend(loc='best', fontsize=9)
#ax1.set_ylabel('$log_{10}(V/m)$',fontsize=9)
#ax1.set_ylim([-14,-6])
plt.xticks(fontsize=9)
plt.yticks(fontsize=9)
plt.xlabel('Z (m)',fontsize=9)
...
#ax1.annotate("previous_qwe produces zero amplitude", xy=(0.48, 0.1), xycoords=ax1.transAxes,fontsize=9)
'''
ax1 = plt.subplot(1, 1, 1)
plt.semilogx(Ex_amp_analytic,depths, '-',color='black', linewidth=1, label='analytic')
plt.semilogx(Ex_amp_our_prog,depths, '--o',color='black', markersize=5, markerfacecolor='None', linewidth=1, label='our_qwe')
plt.semilogx(Ex_amp_empymod_qwe,depths, ':+',color='black', markersize=7, linewidth=1, label='previous_qwe')
plt.legend(loc='best', fontsize=9)
plt.gca().invert_yaxis()
plt.xticks(fontsize=9)
plt.yticks(range(0,3100,500), fontsize=9)
plt.ylabel('Z (m)',fontsize=9)
plt.xlabel('Amplitude of Ex(V/m)',fontsize=9)
ax1.annotate("previous_qwe", xy=(0.01, 0.45), xycoords=ax1.transAxes,fontsize=9)
ax1.annotate("failed", xy=(0.01, 0.35), xycoords=ax1.transAxes,fontsize=9)
plt.show()
